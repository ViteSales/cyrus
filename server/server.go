...
func (s *Server) Run(addr string) (err error) {
	...
	log.Info("Cyrus is up and running HTTP", "address", addr)
...
func (s *Server) RunTLS(addr string, certFile string, keyFile string) (err error) {
	...
	log.Info("Cyrus is up and running HTTPS", "address", addr, "cert", certFile, "key", keyFile)
...
func (s *Server) RunAutoTLS(domain string) (err error) {
	...
	log.Info("Cyrus is up and running HTTPS auto", "domain", domain)
