...
// This file is autogenerated by cyrus
...
{{- if ne .ModelType "Mixin" }}	
	"github.com/vitesales/cyrus-pool/{{ .QueryPackageName }}"
{{- end }}
	"github.com/vitesales/cyrus-pool/{{ .ModelsPackageName }}/{{ .SnakeName }}"
    "github.com/vitesales/cyrus-pool/{{ .InterfacesPackageName }}"
)
