...
import (
	...
	"github.com/vitesales/cyrus/reports"
	"github.com/vitesales/cyrus/server"
	"github.com/vitesales/cyrus/templates"
...
var serverCmd = &cobra.Command{
	...
	Long: `Start the Cyrus server of the project in 'projectDir'.
...
func runProject(projectDir, cmd string, args []string) {
	fmt.Println("Please wait, Cyrus is starting ...")
...
// StartServer starts the Cyrus server. It is meant to be called from
